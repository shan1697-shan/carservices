...
<head>
    <title><? echo lang('create_new_account'); ?> | Social Icon</title>
    <meta charset="UTF-8">
    ...
    <meta name="keywords" content="signup,social network,social media,Social Icon,meet,free platform">
    ...
    <div class="login_signup_navbar">
        ...
        <a href="#" class="login_signup_navbarLinks" style="font-size: 20px;"><? echo lang('help'); ?></a>
        <a href="#" class="login_signup_navbarLinks" style="font-size: 20px;"><? echo lang('terms'); ?></a>
    ...
    <div align="center">
        ...
        <!--============[ sign up sec ]============-->
            ...
            <select class="login_signup_textfield" name="gender" id="gr">
              ...
              <option><?echo lang('others');?></option>
            </select>
            </p>
