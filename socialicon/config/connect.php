...
$username = "id10156642_vilson";
$password = "Vil@300312345";
$dbname = "id10156642_sicon";

// try 
//     {
//     $conn = new PDO("mysql:host=$servername;dbname=$dbname;charset=utf8mb4", $username, $passworde);
