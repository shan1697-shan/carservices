	...
	<div class="row" style="margin: 20px 0px;">
		<div class="col-sm-12">
			...
			<div class="col-sm-3" style=" margin: 0px 2px;">
				<img src="images1/b2.jpg" style="width: 110%;height: 226px;margin: 0px -15px;">
				<h2 style="color: white;">Servicing</h2>
				<ul>	
			...
			<div class="col-sm-4" style=" margin: 0px 2px;">
				<h2 style="color: white;">Servicing Includes</h2>
				<ol>
			...
			<div class="col-sm-3 b2">
				...
				<h5>CC Price: &nbsp&nbsp&nbsp₹5000.00</h5>
				<p>(incl. of tax)</p>
