	...
	<div class="row" style="margin: 20px 0px;">
		<div class="col-sm-12">
			...
			<div class="col-sm-3" style=" margin: 0px 2px;">
				<img src="images1/bg1.jpg" style="width: 110%;height: 233px;margin: 0px -15px;">
				<h3 style="color: white;">Denting and Painting</h3>
				<ul>	
			...
			<div class="col-sm-4" style=" margin: 0px 2px;">
				<h3 style="color: white;">Denting and Painting Includes</h3>
				<ol>
					<li>Dicky</li>
					<li>Bonnet</li>
					<li>Full Body</li>
