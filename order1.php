	...
	<div class="row" style="margin: 20px 0px;">
		<div class="col-sm-12">
			...
			<div class="col-sm-3" style=" margin: 0px 2px;">
				<img src="images1/bg2.jpg" style="width: 110%;height: 226px;margin: 0px -15px;">
				<h2 style="color: white;">Repairing</h2>
				<ul>	
					<li> 1 year warranty</li>
    				<li>Lowest prices</li>
    				<li>High quality repair</li>

				</ul>
			</div>
			<div class="col-sm-4" style=" margin: 0px 2px;">
				<h2 style="color: white;">Repairing Includes</h2>
				<ol>
					<li>Engine</li>
					<li>Breaks</li>
					<li>Gear</li>
			...
			<div class="col-sm-3 b2">
				...
				<h5>CC Price: &nbsp&nbsp&nbsp₹4000.00</h5>
				<p>(incl. of tax)</p>
