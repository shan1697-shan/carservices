		...
		<header >
			<div class="container-fluid " >
				<div class="row header-w3ls-top pt-lg-5 pt-md-4 pt-3 px-lg-5 px-3">
					...
					<div>
						<p align="center" style="font-size: 20px;color: tomato" > <input  id="a11" type="text" name="search" placeholder="Search..." > &nbsp<button class="btn btn-success" style="height: 54px;margin: -1px;opacity: 0.8;">Search</button></p>
					</div>
			</div>
		</header>
		<!-- //header -->
				...
				<div class="col-md-7">
					<div class="img1 img-grid  d-flex align-items-end justify-content-center p-3">
						<div class="img_text_w3ls px-4">
							<h4>Hand Wash</h4>
							<span> </span>
							<p class="text-white">Sed porttitor lectus nibh ras ultricies ligula sed magna dictum porta, lectus nibh ras ultricies. </p>
				...
				<div class="col-md-5 px-md-0 my-md-0 mt-3">
					<div class="img1 img2 img-grid  d-flex align-items-end justify-content-center p-3">
						<div class="img_text_w3ls px-3">
							<h4>Car Glassing</h4>
							<span> </span>
							<p class="text-white">Sed porttitor lectus nibh ras ultricies ligula sed magna dictum porta. </p>
...
<div class="container-fluid">
		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row mb-5">
				...
				<div class="col-lg-5 aboutleft ml-xl-4">
					...
					<p class="border-left pl-3">We provides best online car service in India making car maintenance easy, affordable and completely transparent. We also provide you with the best car service deals. Full car service is faciliated at one of the Carcrew car service centre. So book car service now!					</p>
					...
					<div id="owl-demo" class="owl-carousel">
						<div class="row item-owl">
							...
							<div class="col-md-7 test-review test-tooltip1">
								...
								<p class="quotew3ls">
									<i class="fas fa-quote-left"></i> Consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat,
									sed diam voluptua.
				...
				<div class="col-lg-6 contact-right">
					<div class="w3l-agile">
						<form action="#" method="post">
							...
							<div class="form-group">
								<input type="text" name="phone number" placeholder="Phone number" class="form-control" required="">
							</div>
							<div class="form-group">
				...
				<div class="col-lg-6 contact-left mt-lg-0 mt-5">
					<div class="w3l-agile ">
						...
						<div class="email">
							...
							<p>
								<a href="mailto:info@example.com">aranjan688@gmail.com</a>
							</p>
						</div>
						<!-- map -->
	...
	<div class="footer-bot py-5 text-center">
		<div class="container">
			...
			<!-- social icons -->
			<!-- copyright -->
			<p class="copyright-w3ls"> &copy; 2018 Car Services. All Rights Reserved | Design by Akash sinha
