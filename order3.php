	...
	<div class="row" style="margin: 20px 0px;">
		<div class="col-sm-12">
			...
			<div class="col-sm-3" style=" margin: 0px 2px;">
				<img src="images1/bg4.jpg" style="width: 110%;height: 226px;margin: 0px -15px;">
				<h2 style="color: white;">Car Care</h2>
				<ul>	
			...
			<div class="col-sm-4" style=" margin: 0px 2px;">
				<h2 style="color: white;">Car Care Includes</h2>
				<ol>
					<li>Interior Dry Cleaning</li>
